...
func RegisterWebRoutes(mux *http.ServeMux, clientHandler *ClientHandler, dashboardHandler *DashboardHandler, paymentHandler *api.PaymentHandler) {
	...
	mux.Handle("/dashboard/orders/new", dashboardHandler.DashboardMiddleware(help.Method(http.MethodGet, dashboardHandler.OrderNewPage)))
	mux.Handle("/dashboard/orders/create", dashboardHandler.DashboardMiddleware(help.Method(http.MethodPost, dashboardHandler.ProcessOrderCreate)))
	...
	mux.Handle("/dashboard/transactions/process-payment", dashboardHandler.DashboardMiddleware(http.HandlerFunc(paymentHandler.ProcessPayment)))
